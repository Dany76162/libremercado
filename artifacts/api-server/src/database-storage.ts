...
async function ensureDemoBaseRecords() {
  await db.insert(users).values([
    {
      id: "admin-principal",
      username: "admin",
  ...
  await db.insert(products).values([
    ...
    { id: "prod-8", storeId: "store-4", name: "Pizza Muzzarella Grande", description: "Pizza clásica con muzzarella y salsa de tomate", price: "8500", category: "Pizzas", stock: 99, isActive: true, isSponsored: false, sponsoredPriority: 0 },
    { id: "prod-9", storeId: "store-4", name: "Pizza Especial Grande", description: "Pizza con jamón, morrones, aceitunas y huevo", price: "12000", originalPrice: "14000", category: "Pizzas", stock: 99, isActive: true, isSponsored: false, sponsoredPriority: 0 },
    { id: "prod-10", storeId: "store-5", name: "Remera Algodón Básica", description: "Remera de algodón 100% en varios colores", price: "4500", originalPrice: "6000", category: "ropa", stock: 50, isActive: true, isSponsored: false, sponsoredPriority: 0 },
    { id: "prod-11", storeId: "store-6", name: "Alimento Perro Adulto 15kg", description: "Alimento balanceado premium para perros adultos", price: "25000", originalPrice: "28000", category: "Alimentos", stock: 20, isActive: true, isSponsored: false, sponsoredPriority: 0 },
    { id: "prod-12", storeId: "store-6", name: "Arena Sanitaria 10kg", description: "Arena aglomerante para gatos con control de olores", price: "8000", category: "Higiene", stock: 30, isActive: true, isSponsored: false, sponsoredPriority: 0 },
    {
      id: "prod-3e", storeId: "store-3",
      name: "Smartphone Pro 128GB",
      description: "Celular 5G con cámara triple, pantalla OLED y batería de larga duración.",
      price: "399999", originalPrice: "469999",
      image: uImg("1511707171634-5f897ff02aa9", 500, 500),
      images: JSON.stringify([uImg("1511707171634-5f897ff02aa9",800,800),uImg("1498049794561-7780e7231661",800,800),uImg("1574269909862-7e1d70bb8078",800,800)]),
      category: "celulares", stock: 9, isActive: true, isSponsored: true, sponsoredPriority: 4,
    },
    {
      id: "prod-3f", storeId: "store-3",
      name: "Notebook Ultra 14\"",
      description: "Notebook liviana para trabajo y estudio con 16GB RAM y SSD de 512GB.",
      price: "849999", originalPrice: "949999",
      image: uImg("1517336714739-489689fd1ca8", 500, 500),
      images: JSON.stringify([uImg("1517336714739-489689fd1ca8",800,800),uImg("1593642632559-0c6d3fc62b89",800,800),uImg("1468495244123-6c6c332eeece",800,800)]),
      category: "computacion", stock: 6, isActive: true, isSponsored: true, sponsoredPriority: 3,
    },
  ]).onConflictDoNothing();
  ...
  await db.insert(promos).values([
    ...
    { ...promoBase, id: "promo-5", title: "Zapatillas", description: "Las mejores marcas deportivas", link: "/explore?category=fashion", type: "category", discount: "Hasta 40% OFF", priority: 3 },
    { ...promoBase, id: "promo-6", title: "Moda", description: "Ropa y accesorios para toda la familia", link: "/explore?category=fashion", type: "category", discount: "Hasta 40% OFF", priority: 4 },
    { ...promoBase, id: "promo-7", title: "Nueva temporada de moda", description: "Descubrí las últimas tendencias en Moda Express", link: "/explore?category=fashion", type: "notice", advertiser: "Moda Express", priority: 1 },
    { ...promoBase, id: "promo-8", title: "Jornada de vacunación gratuita", description: "Este sábado vacunación antirrábica para mascotas", type: "notice", advertiser: "Municipalidad", priority: 2 },
  ]).onConflictDoNothing();
...
async function ensureDemoHomeSettings() {
  const entries = {
    cat_img_food: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_grocery: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_pharmacy: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_electronics: "https://images.unsplash.com/photo-1498049794561-7780e7231661?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_fashion: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_home: "https://images.unsplash.com/photo-1484101403633-562f891dc89a?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_beauty: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=300&h=200&fit=crop&auto=format&q=80",
    cat_img_pets: "https://images.unsplash.com/photo-1415369629372-26f2fe60c467?w=300&h=200&fit=crop&auto=format&q=80",
  };

  for (const [key, value] of Object.entries(entries)) {
    await db.insert(siteSettings).values({ key, value, updatedAt: new Date() }).onConflictDoNothing();
  }
}

async function ensureDemoInstitutionalContent() {
  await db.insert(publicEntities).values([
    {
      id: "entity-turismo-cordoba",
      name: "Turismo Córdoba Capital",
      entityType: "municipality",
      logo: uImg("1517457373958-b7bdd4587205", 300, 300),
      banner: uImg("1506744038136-46273834b3fb", 1200, 420),
      description: "Agenda oficial de turismo, eventos y actividades destacadas en la ciudad de Córdoba.",
      provinciaId: "cordoba",
      municipioName: "Córdoba Capital",
      website: "https://turismo.cordoba.gob.ar",
      responsibleName: "Secretaría de Turismo",
      responsibleTitle: "Área institucional",
    ...
    {
      id: "entity-salud-caba",
      name: "Salud Ciudad de Buenos Aires",
      entityType: "organism",
      logo: uImg("1576086213369-97a306d36557", 300, 300),
      banner: uImg("1579684385127-1ef15d508118", 1200, 420),
      description: "Información oficial de campañas, vacunación y servicios de salud de la ciudad.",
      provinciaId: "buenos-aires",
      municipioName: "CABA",
      website: "https://buenosaires.gob.ar/salud",
      responsibleName: "Ministerio de Salud",
      responsibleTitle: "Comunicación pública",
      verificationStatus: "verified",
      isActive: true,
      verifiedAt: new Date(),
      verifiedBy: "admin-principal",
  ...
  await db.insert(secretarias).values([
    {
      id: "sec-turismo-eventos",
      entityId: "entity-turismo-cordoba",
      name: "Agenda y Eventos",
      area: "Turismo",
      description: "Difusión de festivales, ferias y circuitos culturales.",
      logo: uImg("1528605248644-14dd04022da1", 300, 300),
      isActive: true,
    },
    {
      id: "sec-salud-prevencion",
      entityId: "entity-salud-caba",
      name: "Prevención y Campañas",
      area: "Salud",
      description: "Campañas de vacunación y prevención sanitaria.",
      logo: uImg("1516549655169-df83a0774514", 300, 300),
      isActive: true,
    },
  ]).onConflictDoNothing();
  ...
  await db.insert(novedades).values([
    {
      id: "nov-1",
      emitterType: "municipality",
      emitterName: "Turismo Córdoba Capital",
      emitterLogo: uImg("1517457373958-b7bdd4587205", 300, 300),
      isOfficial: true,
      publicEntityId: "entity-turismo-cordoba",
      secretariaId: "sec-turismo-eventos",
      title: "Semana del Turismo Gastronómico",
      summary: "Circuitos gastronómicos, descuentos en comercios adheridos y actividades en plazas céntricas.",
      description: "La ciudad lanza una agenda especial con ferias, food trucks y promociones en comercios gastronómicos durante toda la semana.",
      image: uImg("1414235077428-338989a2e8c0", 900, 600),
    ...
    {
      id: "nov-2",
      emitterType: "organism",
      emitterName: "Salud Ciudad de Buenos Aires",
      emitterLogo: uImg("1576086213369-97a306d36557", 300, 300),
      isOfficial: true,
      publicEntityId: "entity-salud-caba",
      secretariaId: "sec-salud-prevencion",
      title: "Vacunación gratuita para mascotas este sábado",
      summary: "Puestos móviles en plazas y parques con atención de 9 a 15 hs.",
      description: "La campaña oficial acerca vacunación antirrábica y desparasitación básica para perros y gatos en distintos puntos de la ciudad.",
      image: uImg("1548199973-03cce0bbc87b", 900, 600),
      contentType: "card",
      category: "health",
      provinciaId: "buenos-aires",
      municipioName: "CABA",
    ...
    },
    {
      id: "nov-3",
      emitterType: "store",
      emitterName: "Electro Tech",
      emitterLogo: uImg("1518770660439-4636190af475", 300, 300),
      isOfficial: false,
      storeId: "store-3",
      title: "Llegó la nueva línea gamer con cuotas sin interés",
      summary: "Notebooks, periféricos y monitores con financiación especial por tiempo limitado.",
      description: "Electro Tech presenta su nueva selección gamer para la temporada con stock limitado y envíos a todo el país.",
      image: uImg("1542751110-97427bbecf20", 900, 600),
      contentType: "launch",
      category: "launch",
      link: "/store/store-3",
      provinciaId: "cordoba",
    ...
    },
    {
      id: "nov-4",
      emitterType: "brand",
      emitterName: "Moda Express",
      emitterLogo: uImg("1441986300917-64674bd600d8", 300, 300),
      isOfficial: false,
      storeId: "store-5",
      title: "Nueva colección cápsula de verano",
      summary: "Prendas livianas, zapatillas urbanas y descuentos por lanzamiento.",
      description: "La marca activa su colección de verano con combos promocionales y envíos gratis en compras seleccionadas.",
      image: uImg("1496747611176-843222e1e57c", 900, 600),
      contentType: "season",
      category: "fashion",
      link: "/store/store-5",
      provinciaId: "mendoza",
      municipioName: "Mendoza Capital",
      status: "active",
      isFeatured: false,
      priority: 60,
      createdBy: "admin-principal",
...
export async function seedDemoContent() {
  console.log("[db] Seeding demo content for production...");
  await ensureDemoBaseRecords();
  await updateDemoData();
  await db.update(products).set({ category: "zapatillas" }).where(eq(products.id, "prod-5c"));
  await db.update(products).set({ category: "ropa" }).where(eq(products.id, "prod-5d"));
  await db.update(products).set({ category: "ropa" }).where(eq(products.id, "prod-10"));
  await ensureDemoHomeSettings();
  await ensureDemoInstitutionalContent();
  console.log("[db] Production demo content ready.");
}
